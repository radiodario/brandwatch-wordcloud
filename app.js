...
var WordCloudApp = React.createClass({displayName: 'WordCloudApp',
    ...
    return (
      React.createElement("div", {id: "app"}, 
        ...
        React.createElement("div", {className: "container"}, 
          React.createElement("div", {className: "wordcloud"}, 
            React.createElement("svg", {id: "wordcloud"})
          ), 
          React.createElement(Details, {topic: this.state.topic})
        )
      )
    );
  },
...
React.render(React.createElement(WordCloudApp, null), mountNode);
},{"./details":151,"./strings":152,"./wordcloud":154,"react":149}],151:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
var strings = require('./strings');
...
var Details = React.createClass({displayName: 'Details',
  ...
  render : function() {
    ...
    if (topic) {
      ...
      return (
        React.createElement("div", {className: "details"}, 
          React.createElement("h3", null, strings.click_for_details)
        )
      );
    }
...
},{"./strings":152,"react":149}],152:[function(require,module,exports){
module.exports = {

  title: "My Topics Challenge",
  click_for_details: "Click on a topic to see more details",
  det_title: "Information on topic",
  tot_mentions: "Total Mentions",
  pos_mentions: "Positive Mentions",
  neu_mentions: "Neutral Mentions",
...
},{"./topics.json":153,"d3":2,"d3.layout.cloud/d3.layout.cloud":1}]},{},[150,151,152,154])